      ...
      <div className="px-6 py-4 border-t border-gray-200 bg-gray-50" id="claims-cards-desc">
        <div>
          <p className="text-sm text-gray-500">
            Virtualized cards: Showing {cardEndIndex - cardStartIndex} rendered cards of{' '}
            {claimsLength} total claims. Scroll to dynamically load/unload data for optimal
            performance.
          </p>
          <p className="text-xs text-gray-400 mt-1">
            Rendered range: {cardStartIndex + 1}-{Math.min(cardEndIndex, claimsLength)} | Last
